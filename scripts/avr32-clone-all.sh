...
# binutils and gdb
clone_tool origin binutils git@github.com:shaneburrell/avr32-binutils-gdb.git
clone_tool origin gcc      git@github.com:shaneburrell/avr32-gcc.git
clone_tool origin newlib   git@github.com:shaneburrell/avr32-newlib.git
cp -rd binutils gdb
